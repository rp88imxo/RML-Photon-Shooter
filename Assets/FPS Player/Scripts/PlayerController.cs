...
public class PlayerController : MonoBehaviourPun
{
    ...
    #region ADDED_VARS
    /// <summary>
    /// GameObject of model player for control
    /// </summary>
    [SerializeField]
    GameObject playerModel;

    [SerializeField]
    float dirDampTime = 0f;
    ...
    void FixedUpdate()
    {
        ...
        switch (status)
        {
            case Status.idle:
                ...
                break;
            case Status.moving:
                playerAnimator.SetFloat("Speed", movement.walkSpeed,dirDampTime,Time.deltaTime);
